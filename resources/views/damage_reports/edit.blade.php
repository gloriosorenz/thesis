        ...
        <form method="post" action="{{action('DamageReportController@update', $dreport->id)}}">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="calamity" value="{{$dreport->calamity}}"/>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="crop" value="{{$dreport->crop}}"/>
                    </div>
                </div>
                <!-- Crop Stage -->
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="crop_stage" value="{{$dreport->crop_stage}}" />
                    </div>
                </div>
                <!-- Production -->
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="production" value="{{$dreport->production}}" />
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="animal" value="{{$dreport->animal}}" />
                    </div>
                </div>
                <!-- Animal Head -->
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="animal_head" value="{{$dreport->animal_head}}" />
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" name="fish" value="{{$dreport->fish}}"/>
                    </div>
                </div>
                <!-- Area -->
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="area" value="{{$dreport->area}}" />
                    </div>
                </div>
                <!-- Fish Pieces -->
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="fish_pieces" value="{{$dreport->fish_pieces}}" />
                    </div>
                </div>
            </div>
