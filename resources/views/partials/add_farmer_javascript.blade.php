...
$(document).ready(function () {
    ...
    {
        var addRow='<tr>' +
                    '<td><select class="form-control" name="rice_farmers_id" id="rice_farmers_id"><option value="0" selected="true" disabled="True">Select Farmer</option>@foreach ($rice_farmers as $key=>$p)<option value="{{$key}}">{{$p}}</option>@endforeach</select></td>' +
